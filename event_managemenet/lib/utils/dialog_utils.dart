...
import 'package:event_managemenet/widgets/native_loader.dart';
...
Future<void> showSnackbar(BuildContext context,[String? msg,  Color? color]) async {
...
Future<void> showSuccessSnackbar(BuildContext context,[String? msg, Duration? duration]) async {
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(
...
Future<void> showErrorSnackbar( BuildContext context,[String? msg, bool? floating]) async {
